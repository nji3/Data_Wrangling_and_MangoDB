...
def make_pipeline():
    ...
    pipeline = [{'$unwind' : '$isPartOf'},
                {'$group' : {'_id' : {'Region' : '$isPartOf', 'country' : '$country'}, 'Regional City Population Average across Countries' : {'$avg' : '$population'}}},
                {'$group' : {'_id' : '$_id.country', 'avgRegionalPopulation' : {'$avg' : '$Regional City Population Average across Countries'}}}]
    return pipeline

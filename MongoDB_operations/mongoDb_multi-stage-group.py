...
def make_pipeline():
    ...
    pipeline = [{'$match' : {'country' : 'India'}},
                {'$unwind' : '$isPartOf'},
                {'$group' : {'_id' : '$isPartOf', 'India Regional City Population Average' : {'$avg' : '$population'}}},
                {'$group' : {'_id' : 'India Regional City Population Average', 'avg' : {'$avg' : '$India Regional City Population Average'}}}]
    return pipeline
